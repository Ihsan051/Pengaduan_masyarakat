  ...
  <div class="container d-flex justify-content-center align-items-center vh-100">
   <div class="row w-100 justify-content-center align-items-center">
    <div class="col-md-5 d-none d-md-block text-center">
     <img
       src="./asset/Computer.svg"
       alt="Illustration of a person with headphones working on a laptop"
       class="img-fluid"
      ...
      <div class="card-body p-4">
       ...
       <form>
        <div class="mb-3">
         ...
         <input
           type="text"
           class="form-control background-color text-light border-0"
           id="username"
        ...
        <div class="mb-3">
         ...
         <input
           type="password"
           class="form-control background-color text-white border-0"
           id="password"
